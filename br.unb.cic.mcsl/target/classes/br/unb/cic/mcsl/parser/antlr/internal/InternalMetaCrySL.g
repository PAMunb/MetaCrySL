...
@after {
	...
	(
		...
		otherlv_2=':'
		{
			newLeafNode(otherlv_2, grammarAccess.getEventSpecAccess().getColonKeyword_2());
		}
		(
			(
				{
					newCompositeNode(grammarAccess.getEventSpecAccess().getEventsEventParserRuleCall_3_0());
				}
